<template>
  <Transition name="pwa-slide">
    ...
    >
      <div class="pwa-install-icon">
        <img src="/pwa-icon-192.png" alt="財報引擎" width="40" height="40" />
      </div>
  ...
  <Transition name="pwa-slide">
    <div v-if="showPrompt && !needRefresh" class="pwa-install-banner">
      ...
      <div class="pwa-install-text">
        <div class="pwa-install-title">安裝財報引擎</div>
        <div class="pwa-install-desc">加入主畫面，快速開啟 QuantGems 財報工具</div>
      </div>
      <div class="pwa-install-actions">
...
const DISMISS_KEY = 'finengine-pwa-install-dismissed'
...
.pwa-update-banner {
  ...
  box-shadow: 0 8px 32px rgba(45, 212, 191, 0.18);
}
